          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="h-96 w-full">
                {/* Google Maps Embed */}
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12345.67890!2d-73.9876543!3d40.7654321!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zM40zNDUnMTIuMyJOIDczwrA1OSczNS41Ilc!5e0!3m2!1sen!2sus!4v1234567890123!5m2!1sen!2sus" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
            ...
            <div className="mt-8 text-center">
              <a 
                href="https://maps.app.goo.gl/fYmrTvfJnWPdDxsQA" 
                target="_blank" 
